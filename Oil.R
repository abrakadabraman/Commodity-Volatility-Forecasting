...
ggplot(returns_df, aes(x = log_returns)) +
  ...
  labs(title = "Histogram of WTI Log Returns with Normal Curve",
...
#QQ plots
qqnorm(eps, main = "QQ Plot - WTI Returns"); qqline(eps, col = "red")


# Autocorrelation

par(mfrow =c(2,2))
acf(r_xts,    main = "ACF of WTI Returns")
pacf(r_xts,   main = "PACF of WTI Returns")


acf(r_xts^2,  main = "ACF of Squared WTI Returns")
pacf(r_xts^2, main = "PACF of Squared WTI Returns")


par(mfrow = c(1,1))
acf(abs(r_xts),  main = "ACF of Absolute WTI Returns")  
pacf(abs(r_xts), main = "PACF of Absolute WTI Returns")  
...
plot(oil_xts, main = "WTI Closing Prices", ylab = "Price")
